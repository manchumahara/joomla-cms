...
abstract class ModArticlesNewsHelper
{
	...
	public static function getList(&$params)
	{
		...
		foreach ($items as &$item)
		{
			...
			$results                 = $app->triggerEvent('onContentAfterTitle', array('mod_articles_news.article', &$item, &$params, 1));
			$item->afterDisplayTitle = trim(implode("\n", $results));

			$results                    = $app->triggerEvent('onContentBeforeDisplay', array('mod_articles_news.article', &$item, &$params, 1));
